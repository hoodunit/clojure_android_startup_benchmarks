package com.android.helloworldlein;
...
import com.android.helloworldlein.R;
...
public class SplashActivity extends Activity {
    ...
    public void proceed() {
        startActivity(new Intent("com.android.helloworldlein.MAIN"));
        finish();
    }
    ...
    public void loadClojure() {
        new Thread(new Runnable(){
                ...
                public void run() {
                    ...
                    try {
                        Class.forName("com.android.helloworldlein.HelloWorld");
                    } catch (ClassNotFoundException e) {
                        Log.e(TAG, "Failed loading HelloWorld", e);
                    }
